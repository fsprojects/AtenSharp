...
{
    public class ShortAtenTensorUnitTestGenerator
    {
        [Fact]
        public void TestCreationShort0D()
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => ShortAtenTensor.Create());
        }

        [Fact]
        public void TestCreationShort1D()
        {
            Tensor<short> x = ShortAtenTensor.Create(10);
        ...
        {
            Tensor<short> x = ShortAtenTensor.Create(10, 10);
        ...
        {
            var x = ShortAtenTensor.Create(10, 10);
        ...
        {
            Tensor<short> x = ShortAtenTensor.Create(10, 10, 3);
        ...
        {
            var x = ShortAtenTensor.Create(10, 10, 3);
        ...
        {
            Tensor<short> x = ShortAtenTensor.Create(10, 10, 3, 10);
        ...
        {
            var x = ShortAtenTensor.Create(10, 10, 3, 10);
        ...
        {
            var x = ShortAtenTensor.Create(5, 10);
        ...
        public void TestDanglingMemoryShort()
        {
            ...
            using (var x = ShortAtenTensor.Create(10))
            {
                x.Fill(33);
                buffer = x.Buffer;
            }
    ...
    public class IntAtenTensorUnitTestGenerator
    {
        [Fact]
        public void TestCreationInt0D()
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => IntAtenTensor.Create());
        }
        ...
        {
            Tensor<int> x = IntAtenTensor.Create(10, 10);
        ...
        {
            var x = IntAtenTensor.Create(10, 10);
        ...
        {
            Tensor<int> x = IntAtenTensor.Create(10, 10, 3);
        ...
        {
            var x = IntAtenTensor.Create(10, 10, 3);
        ...
        {
            Tensor<int> x = IntAtenTensor.Create(10, 10, 3, 10);
        ...
        {
            var x = IntAtenTensor.Create(10, 10, 3, 10);
        ...
        {
            var x = IntAtenTensor.Create(5, 10);
        ...
        public void TestDanglingMemoryInt()
        {
            ...
            using (var x = IntAtenTensor.Create(10))
            {
                x.Fill(33);
                buffer = x.Buffer;
            }
    ...
    public class LongAtenTensorUnitTestGenerator
    {
        [Fact]
        ...
        {
            Tensor<long> x = LongAtenTensor.Create(10, 10, 3);
        ...
        {
            var x = LongAtenTensor.Create(10, 10, 3);
    ...
    public class DoubleAtenTensorUnitTestGenerator
    {
        [Fact]
        public void TestCreationDouble0D()
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => DoubleAtenTensor.Create());
        }
        ...
        {
            Tensor<double> x = DoubleAtenTensor.Create(10, 10);
        ...
        {
            var x = DoubleAtenTensor.Create(10, 10);
        ...
        {
            Tensor<double> x = DoubleAtenTensor.Create(10, 10, 3);
        ...
        {
            var x = DoubleAtenTensor.Create(10, 10, 3);
        ...
        {
            Tensor<double> x = DoubleAtenTensor.Create(10, 10, 3, 10);
        ...
        {
            var x = DoubleAtenTensor.Create(10, 10, 3, 10);
        ...
        {
            var x = DoubleAtenTensor.Create(5, 10);
        ...
        public void TestDanglingMemoryDouble()
        {
            ...
            using (var x = DoubleAtenTensor.Create(10))
            {
                x.Fill(33);
                buffer = x.Buffer;
            }
    ...
    public class FloatAtenTensorUnitTestGenerator
    {
        [Fact]
        public void TestCreationFloat0D()
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => FloatAtenTensor.Create());
        }

        [Fact]
        public void TestCreationFloat1D()
        {
            Tensor<float> x = FloatAtenTensor.Create(10);
        ...
        {
            Tensor<float> x = FloatAtenTensor.Create(10, 10);
        ...
        {
            var x = FloatAtenTensor.Create(10, 10);
        ...
        {
            Tensor<float> x = FloatAtenTensor.Create(10, 10, 3);
        ...
        {
            var x = FloatAtenTensor.Create(10, 10, 3);
        ...
        {
            Tensor<float> x = FloatAtenTensor.Create(10, 10, 3, 10);
        ...
        {
            var x = FloatAtenTensor.Create(10, 10, 3, 10);
        ...
        {
            var x = FloatAtenTensor.Create(5, 10);
        ...
        public void TestDanglingMemoryFloat()
        {
            ...
            using (var x = FloatAtenTensor.Create(10))
            {
                x.Fill(33);
                buffer = x.Buffer;
            }
